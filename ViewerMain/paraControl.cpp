...
void paraControl::GetSEPara(ParaMRI &mypara)
{
	...
	GetSingleValue(paraTypeEnum::TYPE_LINEEDIT, "Discription", value);
	mypara.Discription = value;
}
...
void paraControl::SetSEPara(ParaMRI mypara)
{
	...
	value = mypara.Discription;
	SetSingleValue(paraTypeEnum::TYPE_LINEEDIT, "Discription", value);
}
